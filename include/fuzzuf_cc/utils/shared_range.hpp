 ...
 */
#ifndef FUZZUF_CC_INCLUDE_UTILS_SHARED_RANGE_HPP
#define FUZZUF_CC_INCLUDE_UTILS_SHARED_RANGE_HPP
#include <boost/range/iterator_range.hpp>
#include <memory>
#include <type_traits>

#include "fuzzuf_cc/utils/range_traits.hpp"
...
class shared_iterator {};
#define FUZZUF_CC_SHARED_ITERATOR_BASIC_OPS                                  \
  using base_iter_t = T;                                                     \
...
class shared_iterator<T, std::shared_ptr<U>,
 ...
 public:
  ...
  FUZZUF_CC_SHARED_ITERATOR_BASIC_OPS
 private:
  base_iter_t p;
  std::shared_ptr<U> sp;
};
