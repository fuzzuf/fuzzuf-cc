// Orig: https://github.com/RUB-SysSec/ijon/blob/master/config.h
/*
...
#define AFL_SIZE_ENV_VAR "__AFL_SIZE"
#define IJON_COUNTER_SIZE_ENV_VAR "__IJON_COUNTER_SIZE"
#define IJON_MAX_SIZE_ENV_VAR "__IJON_MAX_SIZE"
